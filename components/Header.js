...
const Header = () => {
    ...
    return (
        <header className="sticky top-0 flex items-center bg-[#040714] 
        z-[1000] px-10 h-[72px] md:px-12">
            <Image 
                src='/images/logo.svg'
                width={80}
                height={80}
            ...
            }
            {
                ...
                ? (
                    <button 
                        ...
                        tracking-wide hover:bg-white hover:text-black transition duration-200"
                        onClick={signIn}
                    >
                        Login
                    </button>
